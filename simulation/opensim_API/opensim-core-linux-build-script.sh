...
#echo "LOG: INSTALLING SWIG 3.0.8..."
#mkdir -p ~/opensim-workspace/swig-source || true && cd ~/opensim-workspace/swig-source
#wget -nc -q --show-progress https://github.com/swig/swig/archive/refs/tags/v3.0.8.tar.gz
#tar xzf v3.0.8.tar.gz && cd swig-3.0.8
#sh autogen.sh && ./configure --prefix=$HOME/swig --disable-ccache
#make && make -j$NUM_JOBS install  
#echo
...
# export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:~/opensim-core/lib
